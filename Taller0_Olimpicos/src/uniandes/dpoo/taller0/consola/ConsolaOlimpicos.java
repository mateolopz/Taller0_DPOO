...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pa�s que representa un atleta (REQ1_TALLER0)");
	...
	private void ejecutarBuscarAtleta()
	{
		...
		Pais respuesta = calculadora.paisPorAtleta(nombre);
		System.out.println("El atleta es de" + respuesta);
	}
	/**
